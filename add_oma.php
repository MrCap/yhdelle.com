...
function drinkki()
{
  ...
  echo "<form action=\"thx_drinkit_oma.php\" method=\"post\">
  <table><tr><td>nimi:</td> 
  ...
  for($i=0;$i<10;$i++)
  {
    echo "<tr><td>aineosa".$i."</td> 
    <td><input type=\"text\" name=\"aine".$i."\"></td></tr>";
    echo "<tr><td>maara".$i."</td> 
    <td><input type=\"text\" name=\"maara".$i."\"></td></tr>";
...
function booli()
{
  ...
  echo "<form action=\"thx_booli_oma.php\" method=\"post\">
  <table><tr><td>nimi:</td> 
  <td><input type=\"text\" name=\"nimi\"></td></tr>
  ...
  echo"
  <br><br>
  <input type=\"submit\" value=\"Lis&auml;&auml; booli tietokantaan\"/>
  </form>";
}
function juoma()
{
